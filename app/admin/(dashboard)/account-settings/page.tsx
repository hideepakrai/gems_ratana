...
export default function AccountSettingsPage() {
  ...
  const inputClass =
    "w-full rounded-xl border border-border bg-background px-4 py-2.5 text-sm text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/60 transition-all";
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      {/* Toast */}
      {toast && (
        <div className="fixed right-4 top-4 z-50 flex items-center gap-2 rounded-xl bg-primary px-4 py-3 text-sm font-semibold text-white shadow-2xl shadow-primary/30 ring-1 ring-primary/50">
      ...
      {/* ── HERO HEADER ─────────────────────────────── */}
      <div className="relative overflow-hidden rounded-3xl border border-border/40 bg-surface shadow-xl">
        {/* decorative gradient blob */}
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute -top-16 -right-16 h-64 w-64 rounded-full bg-primary/10 blur-3xl" />
          <div className="absolute -bottom-10 -left-10 h-40 w-40 rounded-full bg-secondary/10 blur-2xl" />
        </div>

        <div className="relative px-8 py-8 flex flex-col sm:flex-row items-start sm:items-center gap-8">
          {/* Logo + Favicon block */}
          <div className="flex items-center gap-6">
            {/* Favicon / brand icon */}
            <div className="relative shrink-0">
              <div className="flex h-24 w-24 items-center justify-center rounded-[32px] border-2 border-primary/20 bg-white shadow-xl shadow-primary/10 p-4">
                <img
                  src="/assets/Image/favicon.svg"
                  alt="GemsRatna favicon"
                  className="h-full w-full object-contain"
                />
              </div>
              {/* Camera overlay for avatar upload hint */}
              <button className="absolute -bottom-1 -right-1 flex h-8 w-8 items-center justify-center rounded-full border-2 border-card bg-primary text-white shadow-lg hover:bg-primary/90 transition-colors">
                <Camera size={14} />
              </button>
            </div>
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-3">
                <span className="text-3xl font-heading font-black uppercase tracking-tight text-foreground leading-none">
                  GemsRatna
                </span>
              ...
              <span className="text-[11px] font-bold text-primary/40 tracking-[0.4em] mt-1 uppercase">
                Premium Portal
              </span>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="rounded-2xl border border-border bg-card shadow-sm overflow-hidden">
            <div className="flex items-center gap-3 border-b border-border/60 bg-primary/5 px-6 py-4">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="admin@gemsratna.com"
                  />
                </div>
              </div>
              <div>
              ...
              <div className="flex justify-end pt-2">
                <button
                  ...
                  disabled={saving}
                  className="inline-flex items-center gap-2 rounded-xl bg-primary px-5 py-2.5 text-sm font-bold text-white hover:bg-primary/90 disabled:opacity-60 transition-colors shadow-md shadow-primary/20"
                >
                  <Save size={14} />
          ...
          {/* Brand Assets */}
          <section className="rounded-2xl border border-border bg-card shadow-sm overflow-hidden">
            <div className="flex items-center gap-3 border-b border-border/60 bg-secondary/10 px-6 py-4">
            ...
            <div className="p-6 grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <div className="space-y-3">
                ...
                <div className="rounded-xl border-2 border-dashed border-primary/20 bg-muted/20 p-4 text-center hover:bg-primary/5 hover:border-primary/40 transition-colors">
                  ...
                  <button onClick={() => logoInputRef.current?.click()} className="inline-flex items-center gap-2 rounded-lg bg-secondary px-4 py-2 text-xs font-bold text-primary hover:bg-secondary/80 transition-colors shadow-sm">
              ...
              <div className="space-y-3">
                ...
                <div className="rounded-xl border-2 border-dashed border-primary/20 bg-muted/20 p-4 text-center hover:bg-primary/5 hover:border-primary/40 transition-colors">
                  ...
                  <button onClick={() => faviconInputRef.current?.click()} className="inline-flex items-center gap-2 rounded-lg bg-secondary px-4 py-2 text-xs font-bold text-primary hover:bg-secondary/80 transition-colors shadow-sm">
